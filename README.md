...
• AI's  accuracy increase/decrease: The rate at which an AI hits a player would increase as the probalility of a miss and distance would decrease. Inversely the rate at which an AI hits the player would decrease as the probalility of a miss and the distance between the player and bullets would increase. 
